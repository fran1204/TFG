...
//    }
    ...
    public void addMetaData(Document document) {
        ...
        document.addAuthor("Francisco");
        document.addCreator("Francisco");
    }

    public void addTitlePage(Document document,String titulo, String fecha, String cuerpo)
        ...
        preface.add(new Paragraph(
                "Pago realizado: " + fecha , //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                smallBold));
